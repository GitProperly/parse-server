...
var processMiddleware = function processMiddleware(className, results, auth, middleware, index, promise) {
...
var runQueryMiddleware = function runQueryMiddleware(className, results, auth, config) {
...
RestQuery.prototype.runFind = function () {
  ...
  return this.config.database.find(this.className, this.restWhere, findOptions).then(function (results) {
    ...
    return runQueryMiddleware(_this10.className, results, _this10.auth, _this10.config).then(function (results) {
